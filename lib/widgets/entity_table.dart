...
/// Длинные значения (название, список категорий/конструкторов через
/// запятую) в DataTable иначе просто растягивают колонку вместо переноса —
/// DataTable не ограничивает ширину ячейки сам. Обрезка через
/// TextOverflow.ellipsis требует ограниченной ширины (ПР6, раздел 1.2):
/// без SizedBox текст либо переполнил бы строку, либо (без maxLines)
/// растянул бы таблицу на весь текст целиком.
